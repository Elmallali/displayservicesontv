...
<div class="form-container">
    <h2 class="form-title">Modifier le Paiement</h2>
    ...
    <form action="{{ route('paiements.update', $paiement->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <select name="eleve_id" id="eleve_id" class="form-select @error('eleve_id') is-invalid @enderror" required>
                <option value="" disabled>Sélectionnez un élève</option>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="mois" id="mois" class="form-control @error('mois') is-invalid @enderror" placeholder="Ex: Mai 2025" value="{{ old('mois', $paiement->mois) }}" required>
            @error('mois')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="montant" id="montant" class="form-control @error('montant') is-invalid @enderror" step="0.01" value="{{ old('montant', $paiement->montant) }}" required>
            @error('montant')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" name="date_paiement" id="date_paiement" class="form-control @error('date_paiement') is-invalid @enderror" value="{{ old('date_paiement', $paiement->date_paiement) }}" required>
            @error('date_paiement')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="methode" id="methode" class="form-control @error('methode') is-invalid @enderror" placeholder="Ex: cash, virement, chèque" value="{{ old('methode', $paiement->methode) }}">
            @error('methode')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="est_confirme" id="est_confirme" {{ old('est_confirme', $paiement->est_confirme) ? 'checked' : '' }}>
        ...
        <div class="mb-3">
            ...
            <textarea name="commentaire" id="commentaire" class="form-control @error('commentaire') is-invalid @enderror" rows="3" placeholder="Commentaire optionnel sur ce paiement">{{ old('commentaire', $paiement->commentaire) }}</textarea>
            @error('commentaire')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
